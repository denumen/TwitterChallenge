...
## sentiment metric
For this section, I employed a weighted sentiment approach to evaluate the threads and replies of the tracked account. This approach provides a more reliable metric, as it considers the impact of spam replies and assigns higher weightage to the account owners.
